...
public class Meneger {
	...
	static String database = "Kontakty.accdb";
	static Connection conn; static Statement s; static ResultSet rs; 
	...
	// 'DANE' bedzie sie wprowadzac w jakims formularzu wiec jesli POLE != '' to
	// ustawiamy to pole
